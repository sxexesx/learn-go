...
[примеры](note_7/ex_3/main.go)  

1. Сбор данных из нескольких историчников  
2. Раздача данных для обработки нескольким воркерам [пример](note_7/ex_9/main.go)  
3. Сихронизация потока выполнения
...
### Генератор
Между созданием и возвратом его из функции не должно быть блокирующих функций.
...
### Обертка
Обернуть функцию таймаутом, которая выполняется долго   
[пример](../_tasks/ex_1/main.go)
